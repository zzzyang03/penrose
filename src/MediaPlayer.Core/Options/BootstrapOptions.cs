namespace MediaPlayer.Core.Options;
...
public sealed record PlaybackPolicyOptions
{
    ...
    /// </summary>
    public PlaybackPolicyOptions WithAudioPolicy(MediaPlayer.Core.Playback.AudioPolicy policy) =>
        policy switch
        {
            MediaPlayer.Core.Playback.AudioPolicy.SystemCompatible => this with
            {
                AudioChannels = "auto-safe",
                AudioExclusive = false,
                AudioSpdif = "",
            },
            MediaPlayer.Core.Playback.AudioPolicy.ForceStereo => this with
            {
                AudioChannels = "stereo",
                AudioExclusive = false,
                AudioSpdif = "",
            },
            MediaPlayer.Core.Playback.AudioPolicy.HomeTheaterPcm => this with
            {
                AudioChannels = "7.1,5.1,stereo",
                AudioExclusive = false,
                AudioSpdif = "",
            },
            MediaPlayer.Core.Playback.AudioPolicy.Bitstream => WithNightMode(false) with
            {
                AudioChannels = "auto-safe",
                AudioExclusive = true,
