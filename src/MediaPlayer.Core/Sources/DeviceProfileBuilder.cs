...
{
    public const string ClientName = "MediaPlayer";
    ...
    public static PlaybackCapabilitySnapshot FromRuntime(
        MediaPlayer.Core.Playback.AudioPolicy audioPolicy,
        string? audioDevice,
        bool displayIsHdr,
        string? hwdecCurrent,
        long? gpuAdapterLuid)
    {
        bool bitstream = audioPolicy == MediaPlayer.Core.Playback.AudioPolicy.Bitstream;
        return new PlaybackCapabilitySnapshot
        {
            ...
            {
                MediaPlayer.Core.Playback.AudioPolicy.ForceStereo => "stereo",
                MediaPlayer.Core.Playback.AudioPolicy.HomeTheaterPcm => "7.1",
                _ => "auto",
            },
