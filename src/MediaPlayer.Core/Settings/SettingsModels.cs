...
namespace MediaPlayer.Core.Settings;
...
public sealed record SimpleSettings
{
    ...
    /// <summary>Saved media servers without secrets. Tokens live in <see cref="MediaPlayer.Core.Sources.ICredentialStore"/>.</summary>
