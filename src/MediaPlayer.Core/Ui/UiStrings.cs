...
public sealed record UiStrings
{
    ...
    public static readonly UiStrings Zh = new()
    {
        ...
        AmpNoteAuto = "跟随 Windows 首选设备。注意：auto 在本机上可能先选到 HDMI。",
        DeviceAuto = "自动设备",
    ...
    public static readonly UiStrings En = new()
    {
        ...
        AmpNoteAuto = "Follow Windows default. Note: auto may pick HDMI before laptop speakers on this host.",
