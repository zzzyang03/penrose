...
{
    private const string InstanceKey = "MediaPlayer.App.WinUI";
    ...
    private static bool RedirectIfNecessary()
    {
        ...
        // MEDIAPLAYER_INSTANCE_KEY=<name> runs an independent window (second
        // screen, side-by-side testing) instead of redirecting to the running one.
        string? extra = Environment.GetEnvironmentVariable("MEDIAPLAYER_INSTANCE_KEY");
